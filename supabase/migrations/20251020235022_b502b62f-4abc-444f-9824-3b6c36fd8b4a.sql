-- Criar função para buscar credenciados com documentos agregados
-- Usa LEFT JOIN via SQL (não via Supabase client) para garantir que todos os credenciados sejam retornados
