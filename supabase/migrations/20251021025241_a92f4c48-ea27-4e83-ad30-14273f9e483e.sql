-- Corrigir função sync_credenciado_from_contract para usar dados_contrato como prioridade
...
BEGIN
  ...
  -- Sincronizar CRMs (se houver)
  IF v_inscricao_consultorio IS NOT NULL AND 
     jsonb_typeof(v_inscricao_consultorio->'crms') = 'array' THEN
    ...
    FROM jsonb_array_elements(v_inscricao_consultorio->'crms') AS crm_item
