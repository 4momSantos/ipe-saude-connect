...
import { Map as MapIcon, Phone, Mail, Navigation, Loader2, AlertCircle, Crosshair } from "lucide-react";
          ...
          <div className="relative rounded-lg overflow-hidden border" style={{ height }}>
            {!isLoading && (
              ...
              >
                ...
                {filteredCredenciados && filteredCredenciados.map((credenciado) => (
                  <Marker
                    key={credenciado.id}
                    position={[credenciado.latitude, credenciado.longitude]}
                  >
                    <Popup>
                      <div className="space-y-3 p-1 min-w-[250px]">
                        <div>
